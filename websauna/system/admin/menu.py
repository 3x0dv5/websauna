...
class Entry:
    ...
    def __init__(self, id: str, label: str or None, icon: str=None, caret: str=None, css_class: str=None, template: str=None, submenu: Menu=None, condition: t.Callable=None, link: t.Callable=None, extra: dict=None):
        """
